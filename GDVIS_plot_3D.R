...
#### Create 3D triangle -------------------------------------------------------------------------------- 
    ...
    fig <- plot_ly() %>%
      ...
      # Subsub line
      add_trace(x = c(x.sub1, x.sub2), y = c(y.sub1, y.sub2), z = c(z.sub1, z.sub2),
          type = 'scatter3d', mode = 'lines',
      ...
      # sub2_con line
      add_trace(x = c(x.sub2, x.con), y = c(y.sub2, y.con), z = c(z.sub2, z.con),
          type = 'scatter3d', mode = 'lines',
      ...
      # sub1_con line
      add_trace(x = c(x.con, x.sub1), y = c(y.con, y.sub1), z = c(z.con, z.sub1),
              type = 'scatter3d', mode = 'lines',
      ...
      # Allcases line
      add_trace(x = c(x.allcases, x.con), y = c(y.con, y.allcases), z = c(z.con, z.allcases),
          type = 'scatter3d', mode = 'lines',
    ...
    if (pop.prev_ext == 0.5) { 
      ...
      fig <- fig %>%
        ...
        add_trace(x = c(x.popmean,x.ext), y = c(y.popmean, y.ext), z = c(z.popmean, z.ext),
                  type = 'scatter3d', mode = 'lines',
        ...
        add_trace(x = c(x.popmean,x.extcontrol), y = c(y.popmean, y.extcontrol), z = c(z.popmean, z.extcontrol),
                  type = 'scatter3d', mode = 'lines',
                  line = list(color = "#052954", width = 6),
                  showlegend = FALSE,
                  hoverinfo = 'none')        }
       ...
       add_trace(x = c(x.sub1, x.sub2, x.con),
       ...
       if (show.names == TRUE) {
       fig <- fig %>%
         add_trace(x = c(x.sub1, x.sub2, x.con, x.ext, x.extcontrol),
...
#### Create legend --------------------------------------------------------------------------------            
      ...
      legend <- ggplot() +
        ...
        geom_point(aes(x = 0.1, y = -0.25), shape = 15, size = 4.5, color = "black") +
        geom_text(aes(x = 0.2, y = -0.25), label = name_allcases, color = "black", hjust = 0, size = 5) +
        ...
        geom_text(aes(x = 0.3, y = 0.14), label = paste0(rg_sub1.con_sub2.con, " (", a.deg_sub1.con_sub2.con, "°)"), color = "black", hjust = 0, size = 6) +
        ...
        geom_text(aes(x = 0.3, y = 0.27), label = paste0(rg_sub1.con_sub1.sub2, " (", a.deg_sub1.con_sub1.sub2, "°)"), color = "black", hjust = 0, size = 6) +
        ...
        geom_text(aes(x = 0.3, y = 0.395), label = paste0(rg_sub2.con_sub1.sub2, " (", a.deg_sub2.con_sub1.sub2, "°)"), color = "black", hjust = 0, size = 6) +
        geom_line(aes(x = c(0.1, 0.25), y = c(0.51, 0.48)), color = "gray", linewidth = 2) +
        geom_line(aes(x = c(0.1, 0.25), y = c(0.51, 0.56)), color = "#2075B0", linewidth = 2) +
        geom_text(aes(x = 0.3, y = 0.52), label = paste0(rg_allcases.con_ext, " (", a.deg_allcases.con_ext, "°)"), color = "black", hjust = 0, size = 6) +
        geom_line(aes(x = c(0.1, 0.25), y = c(0.635, 0.605)), color = "#00B050", linewidth = 2) +
        geom_line(aes(x = c(0.1, 0.25), y = c(0.635, 0.685)), color = "#2075B0", linewidth = 2) +
        geom_text(aes(x = 0.3, y = 0.645), label = paste0(rg_sub2.con_ext, " (", a.deg_sub2.con_ext, "°)"), color = "black", hjust = 0, size = 6) +
        geom_line(aes(x = c(0.1, 0.25), y = c(0.765, 0.735)), color = "#ED7D31", linewidth = 2) +
        geom_line(aes(x = c(0.1, 0.25), y = c(0.765, 0.815)), color = "#2075B0", linewidth = 2) +
        geom_text(aes(x = 0.3, y = 0.775), label = paste0(rg_sub1.con_ext, " (", a.deg_sub1.con_ext, "°)"), color = "black", hjust = 0, size = 6) +
        geom_line(aes(x = c(0.1, 0.25), y = c(0.89, 0.86)), color = "#7030A0", linewidth = 2) +
        geom_line(aes(x = c(0.1, 0.25), y = c(0.89, 0.94)), color = "#2075B0", linewidth = 2) +
        geom_text(aes(x = 0.3, y = 0.9), label = paste0(rg_sub1.sub2_ext, " (", a.deg_sub1.sub2_ext, "°)"), color = "black", hjust = 0, size = 6) +
        annotate("text", x = 0, y = 1.05, label = "italic(r)[g] ~ '(degrees)'", color = "black", hjust = 0, size = 6.5, parse = TRUE) +
      
        # plot h2 lines
        geom_line(aes(x = c(0.1, 0.25), y = c(1.25, 1.25)), color = "#2075B0", linewidth = 2) +
        geom_text(aes(x = 0.3, y = 1.26), label = h2_ext, color = "black", hjust = 0, size = 6) +
        geom_line(aes(x = c(0.1, 0.25), y = c(1.375, 1.375)), color = "gray", linewidth = 2) +
        geom_text(aes(x = 0.3, y = 1.385), label = h2_allcases.con, color = "black", hjust = 0, size = 6) +
        geom_line(aes(x = c(0.1, 0.25), y = c(1.5, 1.5)), color = "#7030A0", linewidth = 2) +
        geom_text(aes(x = 0.3, y = 1.51), label = h2_sub1.sub2, color = "black", hjust = 0, size = 6) +
        geom_line(aes(x = c(0.1, 0.25), y = c(1.625, 1.625)), color = "#ED7D31", linewidth = 2) +
        geom_text(aes(x = 0.3, y = 1.635), label = h2_sub1.con, color = "black", hjust = 0, size = 6) +
        geom_line(aes(x = c(0.1, 0.25), y = c(1.75, 1.75)), color = "#00B050", linewidth = 2) +
        geom_text(aes(x = 0.3, y = 1.76), label = h2_sub2.con, color = "black", hjust = 0, size = 6) +
        #annotate("text", x = 0, y = 1.91, label = "italic(h)^2 ~ italic(obs)[50/50]", color = "black", hjust = 0, size = 6.5, parse = TRUE) +
        annotate("text", x = 0, y = 1.91, label = "Heritability", color = "black", hjust = 0, size = 6.5) +
      ...
      ### Save legend
      suppressWarnings({ ggsave(paste0(folder_location, "/", filename3D,"_3D.legend.png"), plot = legend, width = 4, height = 8, dpi = 300) })
